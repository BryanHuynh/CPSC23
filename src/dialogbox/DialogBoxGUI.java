...
public class DialogBoxGUI extends DialogBox {
    ...
    /**
     * used to show any text in a box
     */
    public DialogBoxGUI() {
    ...
    public Font getProggyFont() {
        ...
        try {
            f = Font.createFont(Font.TRUETYPE_FONT,
                    new FileInputStream(new File("additionals/ProggyClean.ttf"))).deriveFont(Font.PLAIN, 35);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        db.render();
        NameGenerator nameGenerator = new NameGenerator("additionals/Names.txt");
        long period = 0;
