...
public class MapGenerator {
    ...
    /**
     * randomly adds entities around the map
     * @param symbol    that type of entity it is
     * @param map
     */
    ...
    /**
     * looks for locations to place boxes on the map
     * @param map
     */
    ...
    /**
     * counts how much entities of a certain type there are on the map
     * @param symbol
     * @param map
     * @return
     */
    ...
    /**
     * construct a room at a give location with additional padding of 1 unit around the room
     * @param x
     * @param y
     * @param map
     */
    ...
    /**
     * removes padding (P) from the map
     * @param map
     */
    ...
    /**
     * randomly sets up doors on walls
     * @param map
     */
    ...
    /**
     * selects 2 doors that are close to each other and links them up without replacement
     * @param map
     */
